...
@include('partials.popup')
        ...
        <div class="card" data-aos="fade-right">
            <div class="card-body">
                ...
                <div class="p-3">
                    <form class="form-horizontal mt-3" method="POST" action="{{route('password.confirm.check')}}">
                        @csrf
                                <div class="text-center mb-4">
                                    <img src="{{asset('image/profile/'.auth()->user()->picture)}}" class="rounded-circle avatar-lg img-thumbnail" alt="thumbnail">
                                </div>
                    ...
                    <hr>
                        ...
                        <div class="form-group mb-0 row mt-2">
                            <div class="col-sm-7 mt-3 text-center">
                                <a href="{{route('dashboard')}}" class="text-muted"><i class="mdi mdi-lock"></i> Return Back</a>
                            </div>
